...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO MY REST API!') // boleh diubah
}
...
var creator = 'WolfCodeX' // ubah jadi nama lu
const listkey = ["CodeXBot","WolfCodeX","FoxyCodeX"]; // ubah apikey nya, tambah aja klo mau
